...
## player position, entity root, and enemy-node registry.
##
...
const _BOSS_DESPAWN_DIST: float = 160.0    # world units (~80 tiles)
const _BOSS_DESPAWN_TIME: float = 300.0    # 5 minutes
