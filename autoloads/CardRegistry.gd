...
static func _ensure_loaded() -> void:
	...
	_loaded = true
	var all: Array = [
		_C_ALIGHT, _C_ANCIENT_GUARDIAN, _C_ASH, _C_BLESSED_LIGHT, _C_BLITZ_GHOUL,
		_C_BRITTLE, _C_BULWARK, _C_CHAR, _C_DAGGER_THROW, _C_DARK_PACT,
		_C_DAWN_ACOLYTE, _C_DAWN_GUARDIAN, _C_DAWN_PALADIN, _C_DRAIN,
		_C_DUSK_VAMPIRE, _C_DUSK_WRAITH, _C_EMBER, _C_FLICKER, _C_GHOST,
		_C_GHOUL, _C_INSIGHT, _C_IRON_REVENANT, _C_MEND, _C_PHOENIX_RISE,
		...
		_C_SPARK, _C_SURGE_SPIRIT, _C_TIME_WARP, _C_VEILED_PALADIN, _C_VOID_WYRM,
		_C_WITHER, _C_ZOMBIE,
	]
	for res in all:
