...
func test_start_siege_sets_town() -> void:
	_sm.town_siege.start_siege("madrian")
	assert_eq(str(_sm.town_siege.get_active_siege().get("town", "")), "madrian")

func test_start_siege_stage_0() -> void:
	_sm.town_siege.start_siege("madrian")
	assert_eq(int(_sm.town_siege.get_active_siege().get("stage", -1)), 0)

func test_start_siege_hero_hp_30() -> void:
	_sm.town_siege.start_siege("madrian")
	assert_eq(int(_sm.town_siege.get_active_siege().get("hero_hp", 0)), 30)

func test_start_siege_day_started_equals_days_elapsed() -> void:
	_sm.days_elapsed = 5
	_sm.town_siege.start_siege("madrian")
	assert_eq(int(_sm.town_siege.get_active_siege().get("day_started", -1)), 5)
...
func test_no_active_siege_returns_empty() -> void:
	assert_true(_sm.town_siege.get_active_siege().is_empty())
...
func test_advance_stage_from_0_to_1() -> void:
	_sm.town_siege.start_siege("madrian")
	_sm.town_siege.advance_siege_stage()
	assert_eq(int(_sm.town_siege.get_active_siege().get("stage", 0)), 1)

func test_advance_stage_from_1_to_2() -> void:
	_sm.town_siege.start_siege("madrian")
	_sm.town_siege.advance_siege_stage()
	_sm.town_siege.advance_siege_stage()
	assert_eq(int(_sm.town_siege.get_active_siege().get("stage", 0)), 2)

func test_advance_stage_no_op_when_empty() -> void:
	_sm.town_siege.advance_siege_stage()   # should not crash
	assert_true(_sm.town_siege.get_active_siege().is_empty())
...
func test_set_siege_hero_hp_updates_value() -> void:
	_sm.town_siege.start_siege("madrian")
	_sm.town_siege.set_siege_hero_hp(15)
	assert_eq(int(_sm.town_siege.get_active_siege().get("hero_hp", 0)), 15)

func test_set_siege_hero_hp_no_op_when_empty() -> void:
	_sm.town_siege.set_siege_hero_hp(10)   # should not crash
	assert_true(_sm.town_siege.get_active_siege().is_empty())
...
func test_end_defeat_clears_siege() -> void:
	_sm.town_siege.start_siege("maykalene")
	_sm.town_siege.end_siege_defeat()
	assert_true(_sm.town_siege.get_active_siege().is_empty())
