...
func test_set_plot_stores_seed_id_and_day() -> void:
	_sm.garden.set_plot(0, "sunpetal", 3)
...
func test_harvest_sunpetal_adds_one_plant() -> void:
	_sm.garden.set_plot(0, "sunpetal", 0)
	...
	_sm.garden.add_plants(plant_id, yield_count)
	_sm.garden.clear_plot(0)
...
func test_harvest_moonroot_adds_two_plants() -> void:
	_sm.garden.set_plot(1, "moonroot", 0)
...
func test_harvest_embercap_adds_two_plants() -> void:
	_sm.garden.set_plot(2, "embercap", 0)
...
func test_empty_plot_returns_zero() -> void:
	assert_eq(_sm.garden.get_plot_growth_stage(0), 0)
...
func test_sunpetal_stage_2_at_day_1() -> void:
	_sm.garden.set_plot(0, "sunpetal", 0)
	_sm.days_elapsed = 1
	assert_eq(_sm.garden.get_plot_growth_stage(0), 2)
...
func test_moonroot_stage_1_at_day_0() -> void:
	_sm.garden.set_plot(0, "moonroot", 0)
	_sm.days_elapsed = 0
	assert_eq(_sm.garden.get_plot_growth_stage(0), 1)
