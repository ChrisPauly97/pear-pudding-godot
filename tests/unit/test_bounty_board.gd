...
func test_accept_returns_true_on_success() -> void:
	var ok: bool = _sm.bounties.accept_bounty("b_deftype")
	assert_true(ok)

func test_accept_returns_false_for_unknown_id() -> void:
	var ok: bool = _sm.bounties.accept_bounty("nonexistent")
	assert_false(ok)
...
func test_accept_three_bounties_succeeds() -> void:
	...
	var ok: bool = _sm.bounties.accept_bounty("b_chests")
...
func test_claim_unknown_id_returns_zero() -> void:
	var paid: int = _sm.bounties.claim_bounty("nonexistent")
	assert_eq(paid, 0)
