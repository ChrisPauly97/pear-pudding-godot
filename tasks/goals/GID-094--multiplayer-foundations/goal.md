...
|----|------|------|--------|------------|
| TID-341 | Raise player cap to 4 + generalize avatar sync to N peers | agent | pending | — |
| TID-342 | Player identity — display name + color + stable token | agent | pending | TID-341 |
