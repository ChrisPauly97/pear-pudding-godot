# TID-401: Chapter 2 Named Maps Skeleton — larik, marsax_hold, War-Camp Dungeon Entry
...
- **NPC dialogue:** placeholder static lines from story.md Chapter 2 NPC table (villagers afraid, hold garrison); flag-gated variants belong to TID-402.
