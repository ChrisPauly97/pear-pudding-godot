...
| TID-094 | Keyword game logic — Ward attack redirection, Surge summon, Shroud absorption | agent | done | TID-093 |
| TID-095 | Keyword UI — display keyword badges on cards in hand and on board | agent | done | TID-093 |
| TID-096 | Keyword card content — new .tres card files bearing keywords | agent | done | TID-094, TID-095 |
