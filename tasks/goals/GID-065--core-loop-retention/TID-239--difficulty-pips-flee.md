# TID-239: Enemy Difficulty Pips in World + Flee Option in Battle
...
- **Grace period:** reuse the `EnemyNPC` engage-cooldown mechanic from TID-238 so the fled enemy doesn't instantly re-engage; ~3s and/or require the player to leave engage range once.
