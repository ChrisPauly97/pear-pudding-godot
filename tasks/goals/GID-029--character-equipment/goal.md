...
|----|------|------|--------|------------|
| TID-106 | Data model — slot field, 3 new SaveManager fields, save v11 migration, BattleScene applies all 4 slots | agent | pending | — |
| TID-107 | New equipment content — 2-3 armor, ring, and trinket `.tres` items with `.uid` sidecars | agent | pending | TID-106 |
