...
| TID-135 | Tap-and-Hold Long Press Detector Component | agent | done | — |
| TID-136 | Card Inspect on Long Press (Battle, Inventory, Shop) | agent | done | TID-135 |
| TID-137 | Tap-and-Hold Onboarding Tutorial | agent | done | TID-135, TID-136 |
| TID-138 | Simplified Battle UI Layout | agent | done | TID-134 |
