...
| TID-183 | Custom waypoint: long-press/click on MapViewOverlay sets a pin shown on compass + minimap, persisted | agent | done | TID-182 |
| TID-184 | Story objective markers derived from Chapter 1 story flags | agent | done | TID-182 |
