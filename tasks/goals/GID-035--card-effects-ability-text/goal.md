...
|----|------|------|--------|------------|
| TID-134 | Inline ability text on card panels | agent | pending | — |
| TID-135 | Extended targeting for single-target spells | agent | pending | TID-134 |
| TID-136 | Minion Emergence system + new cards | agent | pending | TID-134 |
