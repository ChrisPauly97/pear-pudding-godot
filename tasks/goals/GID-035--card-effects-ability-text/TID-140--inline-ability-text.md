# TID-140: Inline Ability Text on Card Panels
...
- For Emergence (added in TID-142): `emergence_effect` and `emergence_power` fields on CardData/CardInstance will have a parallel `_EMERGENCE_LABELS` dict.
...
- **Minion cards with Emergence** (TID-142 adds this): add a small "Emergence: <text>" label above or below KeywordRow. Font ~1.0% vh, amber tint `Color(1.0, 0.85, 0.4)`.
