# TID-399: Draft Story Pack — Ch1 Enrichment, Ending, Dialogue Table, Ch2 Outline
...
- Story bible: docs/human/story.md (human-owned; agent normally never edits — the user explicitly authorized writing the approved pack into it in the GID-108 approval session, 2026-07-02).
...
Drafted in-session as the GID-108 proposal document (two review iterations). User approved on 2026-07-02 and authorized writing the content directly into docs/human/story.md and amending docs/human/specification.md. Content was written by the main session (see TID-400).
