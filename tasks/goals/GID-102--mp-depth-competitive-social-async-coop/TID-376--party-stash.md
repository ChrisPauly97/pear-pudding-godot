...
(template_id)` (instance dicts never carry `is_unique` themselves — see BID-030). This
...
**Backlog:** logged `BID-030--trading-unique-check-not-enforced.md` (renumbered from
BID-025 during integration — that number was already claimed by a sibling task's
