...
**Backlog filed:** `tasks/backlog/BID-029--wager-challenge-button-missing.md` (renumbered
from BID-026 during integration — BID-026 was already taken by a TID-371 finding) — found
