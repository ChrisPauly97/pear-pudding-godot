# BID-025: Card trading never actually enforces the unique-card block
...
This worktree's `tasks/backlog/` tops out at BID-024 at the time this task (TID-376) ran
in an isolated worktree; a sibling task running concurrently in a different worktree may
have also claimed BID-025. The orchestrator should renumber/dedupe on merge if so.
